...
enum PaymentMethods: string
{
    ...
    /**
     * Get all payment methods as an array of values
     */
    ...
    public static function byCategory(string $category): array
    {
        return match ($category) {
            ...
            'virtual_account' => [
                self::VIRTUAL_ACCOUNT_BCA, self::VIRTUAL_ACCOUNT_MANDIRI,
                self::VIRTUAL_ACCOUNT_PERMATA, self::VIRTUAL_ACCOUNT_BPD_BALI,
                self::VIRTUAL_ACCOUNT_ARTHAGRAHA, self::VIRTUAL_ACCOUNT_BNI,
                self::VIRTUAL_ACCOUNT_BRI, self::VIRTUAL_ACCOUNT_MUAMALAT,
                self::VIRTUAL_ACCOUNT_BSI,
            ],
            'bank_transfer' => [
                self::BANK_TRANSFER_BCA, self::BANK_TRANSFER_MANDIRI,
                self::BANK_TRANSFER_ANZ, self::BANK_TRANSFER_STANDARDCARTERED,
            ],
            'credit_card' => [
                self::CREDIT_CARD_MASTERCARD, self::CREDIT_CARD_VISA, self::CREDIT_CARD_JCB,
            ],
            'e_wallet' => [
                self::E_WALLET_LINKAJA, self::E_WALLET_GOPAY, self::E_WALLET_OVO,
                self::E_WALLET_DANA, self::E_WALLET_WECHATPAY, self::E_WALLET_SHOOPEPAY,
                self::E_WALLET_ALIPAY, self::E_WALLET_DOKU, self::E_WALLET_INSTAPAY,
                self::E_WALLET_PAYNOW, self::E_WALLET_DUITNOW, self::E_WALLET_PROMPTPAY,
                self::E_WALLET_FPS, self::E_WALLET_VIETTEL_MONEY, self::E_WALLET_TOSS,
            ],
            default => []
        };
    }
